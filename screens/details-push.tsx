...
export function DetailsPushScreen({route, navigation }: any) {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Button
        title="Details + 1"
        onPress={() => navigation.push('DetailsPush', { id: id + 1 })}
      />
      <Button
        title="Details - 1"
        onPress={() => navigation.push('DetailsPush', { id: id - 1 })}
      ...
      <Button
        title="Details =="
        onPress={() => navigation.push('DetailsPush', same)}
      />
      <Button
        title="Details ø"
        onPress={() => navigation.push('DetailsPush')}
      />
